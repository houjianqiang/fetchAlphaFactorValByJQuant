...
#     record_date = d
#     print(d)
#     exc_str = "insert into records_status (status,insert_date,record_date) VALUES('%s','%s','%s')" % (
...
#
# for x in range(0,731,100):
#     task_list = date_list[x:x+100]
#     thread_list = []
#     for i in range(100):
#         th = threading.Thread(targer=cc_alpha191_data,args=(task_list,))
#         th.start()
...
#     print(e)
# # data= alpha_001('2016-09-09','all')
#
# data = eval("alpha_001('2016-09-09','000300.XSHG')")
# print(data)
# print(data.index.values)
# print(data.values)


# exc_str = 'alpha001' + r"('%s','%s')" % (end_date, exc_code)
# try:
#     data = eval(exc_str)
...
try:
    ...
    print(e)
import numpy as np
data = jq.get_all_trade_days()[-100:]
recent100day_data = data
np.savetxt('recent100day_detail.npy',recent100day_data)
